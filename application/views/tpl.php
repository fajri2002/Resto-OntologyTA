...
<head>
<meta charset="utf-8"/>
<title>Bandung Eateries Finder</title>
<base href="<?= base_url() ?>" />
...
<!-- END THEME STYLES -->
<link rel="shortcut icon" href="cdn/icons/restaurant.png"/>
</head>
<!-- END HEAD -->
<!-- BEGIN BODY -->
	...
	<div class="page-header-top">
		<div class="container">
			...
			<div class="page-logo" style="width:400px">
				<a href="">
                	<div style="float:left; margin-top:21px"><span style="color:#333333;font-size:26px;">Bandung</span> <span style="font-size:26px; color:#ff3f3f;">Eateries</div>
                </a>
			</div>
			<!-- END LOGO -->
		...
		<div class="container">
			...
			<div class="hor-menu ">
				...
				<ul class="nav navbar-nav">
					<li>
						<a href="javascript:u1()"><i class="fa fa-comments"></i> Untuk Kebutuhan Mencari Restoran</a>
					</li>
                    <!-- <li>
